...
public class Cake_Order2 implements ActionListener {
	...
	public Cake_Order2() {
		...
		tf2 = new JTextField(Customer_Inf.mob);
		...
		String[] Month1 = { "January", "Feburary", "March", "April", "May", "June", "July", "August", "September",
				"October", "November", "December" };
		...
		String[] Flavour = { "Vanilla", "Choclate", "ButterScoth", "Pineapple", "Fruit Cake", "Black Forest",
				"Dark Forest" };
		...
		if (ae.getSource() == b1) {
			try {
				java.sql.PreparedStatement ps = con
						.prepareStatement("insert into Cake_Order values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
